...
public:
    ...
    void set_name(char a[]) { strcpy_s(name, a); }
    void set_sex(char a[]) { strcpy_s(sex, a); }
    void set_ID(int n) { ID = n; }
    void set_unit(char a[]) { strcpy_s(unit, a); }
    void set_business(char a[]) { strcpy_s(business, a); }
